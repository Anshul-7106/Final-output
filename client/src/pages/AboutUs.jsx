    ...
    <div className="min-h-screen bg-zinc-900 text-white font-sans overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-lg text-zinc-400 mb-8 max-w-xl">
          ...
          <motion.div variants={fadeUp} className="relative w-full max-w-md">
            <div className="flex items-center bg-zinc-900 border border-zinc-800 rounded-full px-6 py-4 shadow-xl focus-within:border-yellow-500/50 focus-within:ring-1 focus-within:ring-yellow-500/30 transition-all">
              <input 
                type="text" 
                placeholder="Search courses..." 
                className="bg-transparent text-zinc-200 placeholder-zinc-500 w-full focus:outline-none text-lg"
              />
        ...
        >
          <div className="aspect-[4/5] lg:aspect-square rounded-[2.5rem] overflow-hidden shadow-2xl shadow-yellow-500/10 border border-zinc-800/50 relative">
            ...
            <div className="absolute bottom-8 left-8 right-8 bg-zinc-800/80 backdrop-blur-md border border-zinc-700 p-4 rounded-2xl z-20 flex items-center gap-4 shadow-xl">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.h3 variants={fadeUp} className="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight">Empowering Learners,<br/>Elevating Futures.</motion.h3>
          <motion.p variants={fadeUp} className="text-zinc-400 text-lg md:text-xl leading-relaxed font-medium">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center mb-24 md:mb-32">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="order-2 md:order-1">
            ...
            <motion.h4 variants={fadeUp} className="text-3xl font-bold text-white mb-6 tracking-tight">Bridging the Gap in Modern Education</motion.h4>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-24 md:mb-32">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/80 p-8 lg:p-10 rounded-[2rem] hover:border-yellow-500/50 transition-colors group">
            <div className="w-14 h-14 bg-zinc-700 text-white rounded-2xl flex items-center justify-center mb-8 group-hover:bg-yellow-500 group-hover:text-black transition-colors shadow-lg">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>
            </div>
            <h4 className="text-xl font-extrabold text-white mb-4">Comprehensive Materials</h4>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/80 p-8 lg:p-10 rounded-[2rem] hover:border-yellow-500/50 transition-colors group">
            ...
            <h4 className="text-xl font-extrabold text-white mb-4">Practical Skills</h4>
            <p className="text-zinc-400 leading-relaxed">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/80 p-8 lg:p-10 rounded-[2rem] hover:border-yellow-500/50 transition-colors group">
            ...
            <h4 className="text-xl font-extrabold text-white mb-4">EdTech Innovation</h4>
            <p className="text-zinc-400 leading-relaxed">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700 rounded-[2.5rem] p-10 md:p-16 lg:p-20 relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-8 tracking-tight">Education is not a one-size-fits-all journey.</h3>
            ...
            <p className="text-white font-medium text-xl md:text-2xl px-4">
      ...
      {/* Footer */}
      <footer className="bg-zinc-900 border-t border-zinc-800 py-12 text-center relative z-10">
